...
export const createMovieGenre = async (req, res) => {
    try {
        ...
        const newMovieGenre = await query('SELECT * FROM movie_genres WHERE movie_genre_id = ?', [result.lastID]);
...
export const deleteMovieGenre = async (req, res) => {
    try {
        ...
        const existing = await query('SELECT * FROM movie_genres WHERE movie_genre_id = ?', [movieGenreId]);
...
export const getAllMovieCast = async (req, res) => {
    try {
...
export const getAllMovieDirectors = async (req, res) => {
    try {
...
export const createMovieDirector = async (req, res) => {
    try {
        ...
        const newMovieDirector = await query('SELECT * FROM movie_directors WHERE movie_director_id = ?', [result.lastID]);
...
export const deleteMovieDirector = async (req, res) => {
    try {
        ...
        const existing = await query('SELECT * FROM movie_directors WHERE movie_director_id = ?', [movieDirectorId]);
        if (existing.length === 0) {
            res.status(404).json({ message: 'Not found' });
            return;
        }
...
export const getAllMovieProducers = async (req, res) => {
    try {
...
export const createMovieProducer = async (req, res) => {
    try {
        const { movie_id, person_id } = req.body;
        if (!movie_id || !person_id) {
            res.status(400).json({ error: 'movie_id and person_id are required' });
        ...
        const result = await run(sql, [movie_id, person_id]);
        const newMovieProducer = await query('SELECT * FROM movie_producers WHERE movie_producer_id = ?', [result.lastID]);
...
export const deleteMovieProducer = async (req, res) => {
    try {
        ...
        const existing = await query('SELECT * FROM movie_producers WHERE movie_producer_id = ?', [movieProducerId]);
        if (existing.length === 0) {
            res.status(404).json({ message: 'Not found' });
            return;
        }
...
export const getAllMovieStudios = async (req, res) => {
    try {
...
export const createMovieStudio = async (req, res) => {
    try {
        ...
        const newMovieStudio = await query('SELECT * FROM movie_studios WHERE movie_studios_id = ?', [result.lastID]);
...
export const deleteMovieStudio = async (req, res) => {
    try {
        ...
        const existing = await query('SELECT * FROM movie_studios WHERE movie_studios_id = ?', [movieStudiosId]);
        if (existing.length === 0) {
            res.status(404).json({ message: 'Not found' });
            return;
        }
